...
public class plotGraph  extends ApplicationFrame {
     ...
     */
    public plotGraph(final String title, String ax, String ay, double[] x, double[] y, double[] z) {

        super(title);

        final XYDataset dataset = createDataset(x, y, z);
        final JFreeChart chart = createChart(dataset, title, ax, ay);
        final ChartPanel chartPanel = new ChartPanel(chart);
        chartPanel.setPreferredSize(new java.awt.Dimension(1200, 500));
        setContentPane(chartPanel);
     ...
     * @return a sample dataset.
     */
    private XYDataset createDataset(double[] x, double[] y, double[] z) {
