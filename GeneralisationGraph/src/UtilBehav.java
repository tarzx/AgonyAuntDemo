 ...
 *
 */
public class UtilBehav implements IUtil {
	// CSV File in process
	private String dataCSVFileNameLoad = "behaviour.csv";
	private String dataCSVFileName = "behaviourRefine.csv";
	...
	private final int NUM_OUTPUT_BITS = NUM_BEHAV;

	// Whether the net can be parsed for sending to the app
	private boolean ready_to_parse = false;
	
	// neural network file
	private File neuralNetfile = new File("neuralNetSelectBehaviour.eg");
