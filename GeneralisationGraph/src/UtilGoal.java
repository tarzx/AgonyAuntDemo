 ...
 *
 */
public class UtilGoal implements IUtil {
	// CSV File in process
	private String dataCSVFileNameLoad = "goal.csv";
	private String dataCSVFileName = "goalRefine.csv";
	...
	private final int NUM_OUTPUT_BITS = NUM_GOAL;

	// Whether the net can be parsed for sending to the app
	private boolean ready_to_parse = false;
	
	// neural network file
	private File neuralNetfile = new File("neuralNetSelectGoal.eg");
