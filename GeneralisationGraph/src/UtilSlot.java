 ...
 *
 */
public class UtilSlot implements IUtil {
	// CSV File in process
	private String dataCSVFileNameLoad = "slots.csv";
	private String dataCSVFileName = "slotsRefine.csv";
	...
	private final int NUM_OUTPUT_BITS = NUM_SLOT;

	// Whether the net can be parsed for sending to the app
	private boolean ready_to_parse = false;
	
	// neural network file
	private File neuralNetfile = new File("neuralNetslotIntervention.eg");
