 ...
 *
 */
public class UtilFreq implements IUtil {
	// CSV File in process
	private String dataCSVFileNameLoad = "frequency.csv";
	private String dataCSVFileName = "frequencyRefine.csv";
	...
	private final int NUM_OUTPUT_BITS = NUM_FREQ;

	// Whether the net can be parsed for sending to the app
	private boolean ready_to_parse = false;
	
	// neural network file
	private File neuralNetfile = new File("neuralNetfrequencyIntervention.eg");
